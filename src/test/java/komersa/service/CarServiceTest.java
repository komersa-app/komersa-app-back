...
class CarServiceTest {
    ...
    void testCreate() {
        ...
        when(priceService.getById(StaticPrice.ID)).thenReturn(StaticPrice.price1());
        ...
        verify(detailsService, times(1)).getById(StaticPrice.ID);
        verify(priceService, times(1)).getById(StaticPrice.ID);
    ...
    @Test
    void testCreate_EntityNotFoundException_PriceNotFound() {
        when(detailsService.getById(StaticDetails.ID)).thenReturn(StaticDetails.details1());
        when(priceService.getById(StaticPrice.ID)).thenThrow(new EntityNotFoundException("Price not found"));
    ...
    @Test
    void testUpdateById_EntityNotFoundException_PriceNotFound() {
        when(carRepository.findById(StaticCar.ID)).thenReturn(java.util.Optional.of(car));
        when(detailsService.getById(StaticDetails.ID)).thenReturn(StaticDetails.details1());
        when(priceService.getById(StaticPrice.ID)).thenThrow(new EntityNotFoundException("Price not found"));
