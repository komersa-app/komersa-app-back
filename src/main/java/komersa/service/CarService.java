...
public class CarService {
    ...
    public CarService(PriceService priceService, DetailsService detailsService, CarRepository carRepository) {
    ...
    public Car create(Car car) {
        ...
        car.setPrice(priceService.getById(car.getPrice().getId()));
