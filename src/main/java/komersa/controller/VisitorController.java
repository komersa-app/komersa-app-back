...
public class VisitorController {
    ...
    public ResponseEntity<VisitorDtoResponse> getVisitorById(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<VisitorDtoResponse> updateVisitor(@PathVariable("id") Long id, @Valid @RequestBody VisitorDtoRequest visitorDtoRequest) {
        Visitor visitor = VisitorDtoMapper.toModel(visitorDtoRequest);
    ...
    public ResponseEntity<Boolean> deleteVisitor(@PathVariable("id") Long id) {
