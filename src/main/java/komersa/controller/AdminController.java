...
public class AdminController {
    ...
    public ResponseEntity<AdminDtoResponse> getAdminById(@PathVariable("id") int id) {
    ...
    public ResponseEntity<AdminDtoResponse> updateAdmin(@PathVariable("id") int id, @Valid @RequestBody AdminDtoRequest adminDtoRequest) {
        Admin admin = AdminDtoMapper.toModel(adminDtoRequest);
    ...
    public ResponseEntity<Boolean> deleteAdmin(@PathVariable("id") int id) {
